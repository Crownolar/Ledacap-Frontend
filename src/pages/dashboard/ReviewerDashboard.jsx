...
//           <p className="text-2xl font-bold text-yellow-500">9</p>
//         </div>
//         <div className="bg-white p-6 rounded-lg shadow">
//           <h2 className="text-lg font-semibold">Reviewed Samples</h2>
//           <p className="text-2xl font-bold text-green-600">21</p>
//         </div>
//         <div className="bg-white p-6 rounded-lg shadow">
//           <h2 className="text-lg font-semibold">Total Samples</h2>
...
//       {/* Bar Chart */}
//       <div className="bg-white p-6 rounded-lg shadow">
//         <h2 className="text-lg font-semibold mb-4">Reviews by Sample Type</h2>
