...
// // Mock data: sample statuses for this researcher
...
//           <h2 className="text-lg font-semibold">My Total Samples</h2>
//           <p className="text-2xl font-bold">15</p>
//         </div>
//         <div className="bg-white p-6 rounded-lg shadow">
//           <h2 className="text-lg font-semibold">Samples Pending Review</h2>
...
//       {/* Pie Chart */}
//       <div className="bg-white p-6 rounded-lg shadow">
//         <h2 className="text-lg font-semibold mb-4">My Samples by Status</h2>
